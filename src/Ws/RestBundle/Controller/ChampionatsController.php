        ...
        if ($data) {
            foreach ($data as $vData) {
                ...
                $result['list_match'][] = array(
                    ...
                    'logoDomicile' => $this->get('kernel')->getRootDir().'/../web/images/Flag-foot/'.$vData->getCheminLogoDomicile().'.png',// $vData->getTeamsDomicile()->getLogo(),
                    'logoVisiteur' =>$this->get('kernel')->getRootDir().'/../web/images/Flag-foot/'.$vData->getCheminLogoVisiteur().'.png',// $vData->getTeamsVisiteur()->getLogo(),
