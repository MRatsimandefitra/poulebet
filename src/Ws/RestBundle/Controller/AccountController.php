...
//                        var_dump($itemsMatch); die;
                    ...
                    $result['list_match'][] = array(
                        ...
                        'imageFacebook' => ($dataIsGagne) ? 'http://dplb.arkeup.com/upload/admin/facebook/'.$this->getObjectRepoFrom(self::ENTITY_FACEBOOK, array())->getImageOeuf() : $this->getObjectRepoFrom(self::ENTITY_FACEBOOK, array())->getImagePoulebet(),
