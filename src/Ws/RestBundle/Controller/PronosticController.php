            ...
            if(is_array($maths)){
                foreach($maths as $kMatchs => $itemsMatchs){
                        ...
                        $result['list_match'][] = array(
                            ...
                            'logoDomicile' => ''.$this->getParameter('url_poulebet').'/images/Flag-foot/' . $itemsMatchs->getCheminLogoDomicile() . '.png',
                            'logoVisiteur' => ''.$this->getParameter('url_poulebet').'/images/Flag-foot/' . $itemsMatchs->getCheminLogoVisiteur() . '.png',
